 ...
 */
public class PembelianVoucherPaketFragment extends FragmentHelper {
    ...
    public PembelianVoucherPaketFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_pembelian_voucher_paket, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Field from = new Field(inputLblJenisVoucher, inputTxtJenisVoucher);
        fields.add(from);
        ...
        Field to = new Field(inputLblPhone, inputTxtPhone);
        fields.add(to);
